...
Issue #19では、モバイル製品から独立した認証付きCloudflare staging解析ゲートを検証します。初期版アプリは引き続き端末内で解析し、このWorkerへの接続やログインを利用条件にしません。private build・smoke・timeout手順は[cloud README](cloud/README.md)を参照してください。
